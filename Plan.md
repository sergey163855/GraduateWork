...
3. Заполнить все поля валидными данными карты с достаточным количеством средств на счете: Номер карты - 4444444444444441, Месяц - 09, Год - 24, Владелец - Ivanov Ivan, CVC/CVV - 123,
...
1. Открыть главную страницу сервиса http://localhost:8080/,
2. На странице сайта нажимаем на прозрачную кнопку "Купить",
3. Заполнить все поля валидными данными карты с достаточным количеством средств на счете: Номер карты - 4444444444444442, Месяц - 09, Год - 24, Владелец - Ivanov Ivan, CVC/CVV - 123,
4. Нажимаем на красную кнопку "Продолжить",
...
3. Заполнить все поля валидными данными карты с достаточным кредитным лимитом: Номер карты - 4444444444444441, Месяц - 09, Год - 24, Владелец - Ivanov Ivan, CVC/CVV - 123,
4. Нажимаем на красную кнопку "Продолжить",
...
1. Открыть главную страницу сервиса http://localhost:8080/,
2. На странице сайта нажимаем на красную кнопку "Купить в кредит",
3. Заполнить все поля валидными данными карты с достаточным кредитным лимитом: Номер карты - 4444444444444442, Месяц - 09, Год - 24, Владелец - Ivanov Ivan, CVC/CVV - 123;
4. Нажимаем на красную кнопку "Продолжить",
